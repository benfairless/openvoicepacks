...
from openvoicepacks.audio import TXSoundData
...
class Provider:
    ...
    def generate(self, text, voice=None, language=None) -> None:
        """Generate speech from text using the specified voice and language."""
        raise NotImplementedError("Subclasses must implement this method.")

    def process(self, path: str, *args: object, **kwargs: object) -> None:
        """Generate audio from text and write to the given file path.

        Args:
            path (str):
                The file path to write the output audio data to.
            *args (object):
                Additional positional arguments passed to generate().
            **kwargs (object):
                Additional keyword arguments passed to generate().

        """
        audio_data = self.generate(*args, **kwargs)
...
class Piper(Provider):
    ...
    def generate(self, text, voice=None, language=None) -> TXSoundData:
